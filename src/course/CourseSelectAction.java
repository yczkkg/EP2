...
/**
 * Servlet implementation class CourseSelectAction
 */
@WebServlet("/CourseSelectAction")
public class CourseSelectAction extends HttpServlet {
...
/*	      for(int i=0;i<list.length;i++){
		...
		int count=beanDB.setSelectCourse(list,id);	
