...
<%
	...
	int admin_uid = (int)session.getAttribute("admin_uid");
%>
<!-- 页面内容代码修改结束 -->
...
<div class="selfinfo"><h2>欢迎，管理员<%=admin_name %></h2></div>
...
<div class="mainfunc">
	...
	<center><div style="height:5px;width:98%;background-color:#dbfb35;"></div></center>
		<div onclick="location='<%=path %>/servlet/GetMineInfoAction?uid=<%=admin_uid%>&id=<%=admin_num %>'" style="margin-left:40px;margin-top:10px;"class="clickdiv"><div class="imgb"><center><img src="<%=path %>/pics/common/selfinfo.png" style="width:100px;height:100px;"/></center></div><div class="clickfont">个人信息</div></div>
		<div onclick="location='<%=path %>/servlet/CourseListAction?uid=<%=admin_uid%>'" style="margin-left:40px;margin-top:10px;"class="clickdiv"><div class="imgb"><center><img src="<%=path %>/pics/common/course.png" style="width:100px;height:100px;"/></center></div><div class="clickfont">管理课程</div></div>
